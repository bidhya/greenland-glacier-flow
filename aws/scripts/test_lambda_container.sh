...
echo "curl -XPOST \"http://localhost:9000/2015-03-31/functions/function/invocations\" -d '{\"satellite\":\"sentinel2\",\"regions\":\"134_Arsuk\",\"start_date\":\"2025-05-04\",\"end_date\":\"2025-05-07\"}'"